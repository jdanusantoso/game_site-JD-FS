...
//Conditions that will be determined as winner
const actions = {
...
function ShowWinner({winner = 0}) {
  const text = {
    "-1": "I've given up. You win.",
    0: "I am not insane, but I believe we've tied.",
    1: "Bazinga! You are terrible!",
  };
...
function App() {
  ...
  return (
    <div className="center">
      <h1>Rock Paper Scissors (Big Bang Theory Style)</h1>
      <div>
        <div className="container">
          <Player name="Player" score={playerScore} action={playerAction} />
          <Player name="Ties" score={ties}  />
          <Player
            name="Sheldon"
            score={computerScore}
        ...
        <div className="number of rounds">
            <h2 id="rounds">Number of Rounds: <span>{round}</span> </h2>
        </div>
